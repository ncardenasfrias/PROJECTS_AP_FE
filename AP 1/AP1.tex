...
Because we are interested in the underlying determinants of the risk premia, and due to data availability issues, we decided to have a broad analysis with monthly data for our selection of
...
We include both exogeneous and endogenous macroeconomic risk factors as well as an approximation to implement \cite{famaCommonRiskFactors1993} three-factor model which used stock specific data. 
...
By definition, these risks cannot be diversified because they affect the returns of all asset and thus has to be compensated which is the focal point of our study. 
    ...
    \subsection{Identify the risk factors}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.9\textwidth]{Images/macroseries_raw.jpeg}
            \caption{ML algorithms and discrimination}
            \label{fig:rawmacro}
