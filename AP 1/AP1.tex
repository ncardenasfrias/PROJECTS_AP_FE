...
To estimate the lambda coefficients we need to have a new dependent variable: the historical k=mean return of every stock in order to get a cross-sectional analysis. 
To do this last part of the analysis we kept the 
