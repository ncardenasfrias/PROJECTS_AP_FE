...
Results are shown in the following table and graph. I am really sorry for the size of the table, I didn't manage to split the \LaTeX table but it can be seen in html file in this link \href{https://github.com/ncardenasfrias/PROJECTS_AP_FE/blob/341de630b010607974fcee5ceffaa89440942c5b/AP%201/Images/betas_exo.jpeg}{HERE.}. 
We shall note that most coefficients are non-significative for every stock.
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Images/exovar_only.png}
...
%\input{Tables/betas_exo_endo.tex}
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Images/exoendo.png}
...
Note that in these regressions, the coefficient on inflation risk is rarely significant which is consistent with the period studied being a time of structurally low inflation but for the last two years: French companied were not exposed to rising prices risk in general. 
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Images/exoff.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Images/myff.png}
    \caption{Betas: exogenous and French and Fama factors}
    \label{fig:rawmacro}
    %\caption*{\footnotesize{\emph{Notes}: }}
\end{figure}
...
We decided to only keep the model with the exogenous factors and the French and Fama factors in monthly frequency and run: 
\begin{equation}
...
\input{Tables/trend_macro.tex}
\input{Tables/drift_macro.tex}
\input{Tables/drift_none.tex}
