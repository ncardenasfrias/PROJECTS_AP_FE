...
Since we are interested in the underlying determinants of the risk premia, and due to data availability issues, we decided to have a broad analysis at the
...
The other series that we use are the following: 
\begin{itemize}
