...
To assess the behavior of teh cyclical component, we detrend the series, substract the coefficient of teh constant and remove the seasonal component when teh coefficients are significant at the 5\% level.
